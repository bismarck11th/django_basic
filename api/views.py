...
# render_json_response() はJSONP にも対応。
# スマホのAPIだけでなく、JavascriptのAjaxでJSONを取得する場合にも応用できる。
...
# OrderedDicr -> https://www.sejuku.net/blog/68322
# OrderedDictを使用すれば追加した要素の順番が保持される